...
static_assert(sizeof(FGIMiscSetting) == 0x0000C0, "Wrong size on FGIMiscSetting");
...
public:
	...
	struct FGIMiscSetting                         MiscSetting;                                       // 0x0530(0x00C0)(Edit, BlueprintVisible, Interp, NoDestructor, NativeAccessSpecifierPublic)
	struct FGIClusteredStuffSetting               ClusteredStuffSetting;                             // 0x05F0(0x0018)(Edit, BlueprintVisible, Interp, NativeAccessSpecifierPublic)
	struct FKuroGIMPCSetting                      GIMPCSetting;                                      // 0x0608(0x00B0)(Edit, BlueprintVisible, Interp, NativeAccessSpecifierPublic)
	struct FKuroPostProcessSetting                KuroPostProcess;                                   // 0x06B8(0x0038)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FGlobalLightSetting                    GlobalLightSetting;                                // 0x06F0(0x000C)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_6FC[0x254];                                    // 0x06FC(0x0254)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FKuroGISetting) == 0x000010, "Wrong alignment on FKuroGISetting");
static_assert(sizeof(FKuroGISetting) == 0x000950, "Wrong size on FKuroGISetting");
...
static_assert(offsetof(FKuroGISetting, ClusteredStuffSetting) == 0x0005F0, "Member 'FKuroGISetting::ClusteredStuffSetting' has a wrong offset!");
static_assert(offsetof(FKuroGISetting, GIMPCSetting) == 0x000608, "Member 'FKuroGISetting::GIMPCSetting' has a wrong offset!");
static_assert(offsetof(FKuroGISetting, KuroPostProcess) == 0x0006B8, "Member 'FKuroGISetting::KuroPostProcess' has a wrong offset!");
static_assert(offsetof(FKuroGISetting, GlobalLightSetting) == 0x0006F0, "Member 'FKuroGISetting::GlobalLightSetting' has a wrong offset!");
...
static_assert(sizeof(FKuroSunLensflareManager) == 0x000090, "Wrong size on FKuroSunLensflareManager");
