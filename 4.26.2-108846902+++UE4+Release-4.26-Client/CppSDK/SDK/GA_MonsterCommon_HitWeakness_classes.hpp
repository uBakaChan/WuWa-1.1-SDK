...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_MonsterCommon_HitWeakness_C;     // 0x0540(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(UGA_MonsterCommon_HitWeakness_C) == 0x000548, "Wrong size on UGA_MonsterCommon_HitWeakness_C");
static_assert(offsetof(UGA_MonsterCommon_HitWeakness_C, UberGraphFrame_GA_MonsterCommon_HitWeakness_C) == 0x000540, "Member 'UGA_MonsterCommon_HitWeakness_C::UberGraphFrame_GA_MonsterCommon_HitWeakness_C' has a wrong offset!");
