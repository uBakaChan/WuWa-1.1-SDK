...
public:
	...
	struct FMinimalViewInfo                       Inout;                                             // 0x0010(0x06C0)(Parm, OutParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(KuroRenderingRuntimeBPPluginBPLibrary_GetCacheCameraInfo) == 0x0006D0, "Wrong size on KuroRenderingRuntimeBPPluginBPLibrary_GetCacheCameraInfo");
...
public:
	const class UObject*                          WorldContextObject;                                // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FWorldPartitionStreamingQuerySource    QuerySource;                                       // 0x0008(0x0080)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	TArray<struct FWorldPartitionRuntimeSpatialHashCell> OutCells;                                          // 0x0088(0x0010)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(KuroRenderingRuntimeBPPluginBPLibrary_GetStreamingCells) == 0x0000A0, "Wrong size on KuroRenderingRuntimeBPPluginBPLibrary_GetStreamingCells");
...
static_assert(offsetof(KuroRenderingRuntimeBPPluginBPLibrary_GetStreamingCells, OutCells) == 0x000088, "Member 'KuroRenderingRuntimeBPPluginBPLibrary_GetStreamingCells::OutCells' has a wrong offset!");
static_assert(offsetof(KuroRenderingRuntimeBPPluginBPLibrary_GetStreamingCells, ReturnValue) == 0x000098, "Member 'KuroRenderingRuntimeBPPluginBPLibrary_GetStreamingCells::ReturnValue' has a wrong offset!");
