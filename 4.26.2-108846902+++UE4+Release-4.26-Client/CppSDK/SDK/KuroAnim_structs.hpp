...
public:
	struct FPoseLink                              Base;                                              // 0x0010(0x0010)(Edit, BlueprintVisible, NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FPoseLink                              CurveAnim;                                         // 0x0020(0x0010)(Edit, BlueprintVisible, NoDestructor, Protected, NativeAccessSpecifierProtected)
	float                                         TexEyeOpenId;                                      // 0x0030(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         TexEyeCloseId;                                     // 0x0034(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         Alpha;                                             // 0x0038(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         TexEyeCloseThreshold;                              // 0x003C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class USkeletalMeshComponent*                 TexFaceMeshComp;                                   // 0x0040(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   TexMatSlotName;                                    // 0x0048(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   TexFaceSwitchKey;                                  // 0x0054(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   TexTargetCurveName;                                // 0x0060(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   FaceSwitchRowName;                                 // 0x006C(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         FaceSwitchRowNum;                                  // 0x0078(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_7C[0x4];                                       // 0x007C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           MouthCurves;                                       // 0x0080(0x0010)(Edit, BlueprintVisible, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	class FName                                   MouthAlpha;                                        // 0x0090(0x000C)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         MouthAlphaThreshold;                               // 0x009C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         OpenMouthThreshold;                                // 0x00A0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         OpenMouthTexId;                                    // 0x00A4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(FAnimNode_TextureFace) == 0x0000C0, "Wrong size on FAnimNode_TextureFace");
...
static_assert(offsetof(FAnimNode_TextureFace, TexEyeOpenId) == 0x000030, "Member 'FAnimNode_TextureFace::TexEyeOpenId' has a wrong offset!");
static_assert(offsetof(FAnimNode_TextureFace, TexEyeCloseId) == 0x000034, "Member 'FAnimNode_TextureFace::TexEyeCloseId' has a wrong offset!");
static_assert(offsetof(FAnimNode_TextureFace, Alpha) == 0x000038, "Member 'FAnimNode_TextureFace::Alpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_TextureFace, TexEyeCloseThreshold) == 0x00003C, "Member 'FAnimNode_TextureFace::TexEyeCloseThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_TextureFace, TexFaceMeshComp) == 0x000040, "Member 'FAnimNode_TextureFace::TexFaceMeshComp' has a wrong offset!");
static_assert(offsetof(FAnimNode_TextureFace, TexMatSlotName) == 0x000048, "Member 'FAnimNode_TextureFace::TexMatSlotName' has a wrong offset!");
static_assert(offsetof(FAnimNode_TextureFace, TexFaceSwitchKey) == 0x000054, "Member 'FAnimNode_TextureFace::TexFaceSwitchKey' has a wrong offset!");
static_assert(offsetof(FAnimNode_TextureFace, TexTargetCurveName) == 0x000060, "Member 'FAnimNode_TextureFace::TexTargetCurveName' has a wrong offset!");
static_assert(offsetof(FAnimNode_TextureFace, FaceSwitchRowName) == 0x00006C, "Member 'FAnimNode_TextureFace::FaceSwitchRowName' has a wrong offset!");
static_assert(offsetof(FAnimNode_TextureFace, FaceSwitchRowNum) == 0x000078, "Member 'FAnimNode_TextureFace::FaceSwitchRowNum' has a wrong offset!");
static_assert(offsetof(FAnimNode_TextureFace, MouthCurves) == 0x000080, "Member 'FAnimNode_TextureFace::MouthCurves' has a wrong offset!");
static_assert(offsetof(FAnimNode_TextureFace, MouthAlpha) == 0x000090, "Member 'FAnimNode_TextureFace::MouthAlpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_TextureFace, MouthAlphaThreshold) == 0x00009C, "Member 'FAnimNode_TextureFace::MouthAlphaThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_TextureFace, OpenMouthThreshold) == 0x0000A0, "Member 'FAnimNode_TextureFace::OpenMouthThreshold' has a wrong offset!");
static_assert(offsetof(FAnimNode_TextureFace, OpenMouthTexId) == 0x0000A4, "Member 'FAnimNode_TextureFace::OpenMouthTexId' has a wrong offset!");
