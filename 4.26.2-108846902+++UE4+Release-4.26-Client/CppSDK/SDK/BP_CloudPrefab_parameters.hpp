...
public:
	...
	class UMaterialInstanceDynamic*               CallFunc_CreateDMI_DMI_1;                          // 0x0070(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue_2;                    // 0x0078(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_79[0x7];                                       // 0x0079(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UMaterialInstanceDynamic*               CallFunc_CreateDMI_DMI_2;                          // 0x0080(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(BP_CloudPrefab_C_UserConstructionScript, CallFunc_CreateDMI_DMI) == 0x000068, "Member 'BP_CloudPrefab_C_UserConstructionScript::CallFunc_CreateDMI_DMI' has a wrong offset!");
static_assert(offsetof(BP_CloudPrefab_C_UserConstructionScript, CallFunc_CreateDMI_DMI_1) == 0x000070, "Member 'BP_CloudPrefab_C_UserConstructionScript::CallFunc_CreateDMI_DMI_1' has a wrong offset!");
...
static_assert(offsetof(BP_CloudPrefab_C_UserConstructionScript, CallFunc_CreateDMI_DMI_2) == 0x000080, "Member 'BP_CloudPrefab_C_UserConstructionScript::CallFunc_CreateDMI_DMI_2' has a wrong offset!");
...
public:
	...
	struct FHitResult                             CallFunc_K2_SetWorldRotation_SweepHitResult;       // 0x00F8(0x0094)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
...
static_assert(offsetof(BP_CloudPrefab_C_Single_Cloud_Parameters_Initial, CallFunc_Conv_BoolToFloat_ReturnValue) == 0x0000E4, "Member 'BP_CloudPrefab_C_Single_Cloud_Parameters_Initial::CallFunc_Conv_BoolToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CloudPrefab_C_Single_Cloud_Parameters_Initial, CallFunc_MakeRotator_ReturnValue) == 0x0000E8, "Member 'BP_CloudPrefab_C_Single_Cloud_Parameters_Initial::CallFunc_MakeRotator_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CloudPrefab_C_Single_Cloud_Parameters_Initial, CallFunc_Conv_IntToFloat_ReturnValue) == 0x0000F4, "Member 'BP_CloudPrefab_C_Single_Cloud_Parameters_Initial::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CloudPrefab_C_Single_Cloud_Parameters_Initial, CallFunc_K2_SetWorldRotation_SweepHitResult) == 0x0000F8, "Member 'BP_CloudPrefab_C_Single_Cloud_Parameters_Initial::CallFunc_K2_SetWorldRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(BP_CloudPrefab_C_Single_Cloud_Parameters_Initial, CallFunc_Not_PreBool_ReturnValue) == 0x00018C, "Member 'BP_CloudPrefab_C_Single_Cloud_Parameters_Initial::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CloudPrefab_C_Single_Cloud_Parameters_Initial, CallFunc_Conv_BoolToFloat_ReturnValue_1) == 0x000190, "Member 'BP_CloudPrefab_C_Single_Cloud_Parameters_Initial::CallFunc_Conv_BoolToFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_CloudPrefab_C_Single_Cloud_Parameters_Initial, CallFunc_IsValid_ReturnValue) == 0x000194, "Member 'BP_CloudPrefab_C_Single_Cloud_Parameters_Initial::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
public:
	...
	struct FHitResult                             CallFunc_K2_SetWorldRotation_SweepHitResult;       // 0x0060(0x0094)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
...
static_assert(offsetof(BP_CloudPrefab_C_Single_Building_Parameters_Initial, CallFunc_K2_SetWorldRotation_SweepHitResult) == 0x000060, "Member 'BP_CloudPrefab_C_Single_Building_Parameters_Initial::CallFunc_K2_SetWorldRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(BP_CloudPrefab_C_Single_Building_Parameters_Initial, CallFunc_IsValid_ReturnValue) == 0x0000F4, "Member 'BP_CloudPrefab_C_Single_Building_Parameters_Initial::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_CloudPrefab_C_Single_Building_Parameters_Initial, CallFunc_GetScalarParameterValue_ReturnValue_1) == 0x0000F8, "Member 'BP_CloudPrefab_C_Single_Building_Parameters_Initial::CallFunc_GetScalarParameterValue_ReturnValue_1' has a wrong offset!");
