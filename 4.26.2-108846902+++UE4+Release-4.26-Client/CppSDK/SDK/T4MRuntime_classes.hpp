...
public:
	...
	TArray<struct FVector4>                       LandscapeLayerParams;                              // 0x0610(0x0010)(ZeroConstructor, TextExportTransient, NativeAccessSpecifierPublic)
	TArray<class UMaterialInstanceConstant*>      MaterialInstances;                                 // 0x0620(0x0010)(ZeroConstructor, TextExportTransient, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UT4MLandscapeComponent) == 0x000630, "Wrong size on UT4MLandscapeComponent");
...
static_assert(offsetof(UT4MLandscapeComponent, LandscapeLayerParams) == 0x000610, "Member 'UT4MLandscapeComponent::LandscapeLayerParams' has a wrong offset!");
static_assert(offsetof(UT4MLandscapeComponent, MaterialInstances) == 0x000620, "Member 'UT4MLandscapeComponent::MaterialInstances' has a wrong offset!");
