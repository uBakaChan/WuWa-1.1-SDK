...
// Function TsMeshAnimBlueprintFunctionLibrary.TsMeshAnimBlueprintFunctionLibrary_C.EnableTickUro
// 0x0010 (0x0010 - 0x0000)
struct TsMeshAnimBlueprintFunctionLibrary_C_EnableTickUro final
{
public:
	int32                                         EntityId;                                          // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(TsMeshAnimBlueprintFunctionLibrary_C_EnableTickUro) == 0x000008, "Wrong alignment on TsMeshAnimBlueprintFunctionLibrary_C_EnableTickUro");
static_assert(sizeof(TsMeshAnimBlueprintFunctionLibrary_C_EnableTickUro) == 0x000010, "Wrong size on TsMeshAnimBlueprintFunctionLibrary_C_EnableTickUro");
static_assert(offsetof(TsMeshAnimBlueprintFunctionLibrary_C_EnableTickUro, EntityId) == 0x000000, "Member 'TsMeshAnimBlueprintFunctionLibrary_C_EnableTickUro::EntityId' has a wrong offset!");
static_assert(offsetof(TsMeshAnimBlueprintFunctionLibrary_C_EnableTickUro, __WorldContext) == 0x000008, "Member 'TsMeshAnimBlueprintFunctionLibrary_C_EnableTickUro::__WorldContext' has a wrong offset!");
