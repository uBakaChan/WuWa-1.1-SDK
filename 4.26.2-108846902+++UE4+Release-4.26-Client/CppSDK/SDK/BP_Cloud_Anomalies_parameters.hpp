...
static_assert(offsetof(BP_Cloud_Anomalies_C_UserConstructionScript, CallFunc_CreateDMI_DMI) == 0x000008, "Member 'BP_Cloud_Anomalies_C_UserConstructionScript::CallFunc_CreateDMI_DMI' has a wrong offset!");
