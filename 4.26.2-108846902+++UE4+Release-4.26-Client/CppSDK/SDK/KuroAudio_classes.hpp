...
{
public:
	uint8                                         Pad_38[0x278];                                     // 0x0038(0x0278)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UKuroAudioEnvironmentSubsystem) == 0x0002B0, "Wrong size on UKuroAudioEnvironmentSubsystem");
