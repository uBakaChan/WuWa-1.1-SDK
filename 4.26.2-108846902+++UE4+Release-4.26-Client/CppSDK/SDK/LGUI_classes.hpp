...
public:
	...
	uint8                                         Pad_1F4[0x4C];                                     // 0x01F4(0x004C)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_120[0x3B0];                                    // 0x0120(0x03B0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	class UTexture*                               DynamicAtlasTexture;                               // 0x0800(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UUITexture) == 0x000810, "Wrong size on UUITexture");
...
static_assert(offsetof(UUITexture, DynamicAtlasTexture) == 0x000800, "Member 'UUITexture::DynamicAtlasTexture' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1F0[0x7];                                      // 0x01F0(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1F8[0x2];                                      // 0x01F8(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	TMap<class FString, struct FMargin>           CustomDeviceMargins;                               // 0x0138(0x0050)(Edit, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UUISafeZone) == 0x0001A0, "Wrong size on UUISafeZone");
...
static_assert(offsetof(UUISafeZone, CustomDeviceMargins) == 0x000138, "Member 'UUISafeZone::CustomDeviceMargins' has a wrong offset!");
...
static_assert(sizeof(UUIDrawcallMesh) == 0x000560, "Wrong size on UUIDrawcallMesh");
...
public:
	...
	TArray<class FString>                         Hyperlinks;                                        // 0x0810(0x0010)(Edit, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_820[0x8];                                      // 0x0820(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(const class FString& HyperLink)> OnHyperLinkClickCallBack;                          // 0x0828(0x0028)(Edit, ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
	uint8                                         Pad_850[0x80];                                     // 0x0850(0x0080)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bEnableTextRenderSystemV2;                         // 0x08D0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_8D1[0x10F];                                    // 0x08D1(0x010F)(Fixing Size After Last Property [ Dumper-7 ])
	class UUITextClickComponent*                  ClickComponent;                                    // 0x09E0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_9E8[0x28];                                     // 0x09E8(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void()>                             OnSelfLanguageChange;                              // 0x0A10(0x0028)(Edit, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, NativeAccessSpecifierPublic)
	TDelegate<void()>                             OnTextureAsyncLoaded;                              // 0x0A38(0x0028)(Edit, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, NativeAccessSpecifierPublic)
	uint32                                        TranslateId;                                       // 0x0A60(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UUIText, Hyperlinks) == 0x000810, "Member 'UUIText::Hyperlinks' has a wrong offset!");
static_assert(offsetof(UUIText, OnHyperLinkClickCallBack) == 0x000828, "Member 'UUIText::OnHyperLinkClickCallBack' has a wrong offset!");
static_assert(offsetof(UUIText, bEnableTextRenderSystemV2) == 0x0008D0, "Member 'UUIText::bEnableTextRenderSystemV2' has a wrong offset!");
static_assert(offsetof(UUIText, ClickComponent) == 0x0009E0, "Member 'UUIText::ClickComponent' has a wrong offset!");
static_assert(offsetof(UUIText, OnSelfLanguageChange) == 0x000A10, "Member 'UUIText::OnSelfLanguageChange' has a wrong offset!");
static_assert(offsetof(UUIText, OnTextureAsyncLoaded) == 0x000A38, "Member 'UUIText::OnTextureAsyncLoaded' has a wrong offset!");
static_assert(offsetof(UUIText, TranslateId) == 0x000A60, "Member 'UUIText::TranslateId' has a wrong offset!");

// Class LGUI.UITextInputComponent
// 0x02F8 (0x06C8 - 0x03D0)
...
public:
	...
	uint8                                         Pad_590[0x14];                                     // 0x0590(0x0014)(Fixing Size After Last Property [ Dumper-7 ])
	TWeakObjectPtr<class UUISprite>               CaretObject;                                       // 0x05A4(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	TDelegate<void(const class FString& InString)> OnTextChange;                                      // 0x0628(0x0028)(Edit, ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
	TDelegate<void(const class FString& InString)> OnTextSubmit;                                      // 0x0650(0x0028)(Edit, ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
	TDelegate<void(const class FString& InString)> OnTextClip;                                        // 0x0678(0x0028)(Edit, ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
	TDelegate<void(bool InActivate)>              OnInputActivateDelegate;                           // 0x06A0(0x0028)(Edit, ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UUITextInputComponent) == 0x0006C8, "Wrong size on UUITextInputComponent");
...
static_assert(offsetof(UUITextInputComponent, CaretObject) == 0x0005A4, "Member 'UUITextInputComponent::CaretObject' has a wrong offset!");
...
static_assert(offsetof(UUITextInputComponent, OnTextChange) == 0x000628, "Member 'UUITextInputComponent::OnTextChange' has a wrong offset!");
static_assert(offsetof(UUITextInputComponent, OnTextSubmit) == 0x000650, "Member 'UUITextInputComponent::OnTextSubmit' has a wrong offset!");
static_assert(offsetof(UUITextInputComponent, OnTextClip) == 0x000678, "Member 'UUITextInputComponent::OnTextClip' has a wrong offset!");
static_assert(offsetof(UUITextInputComponent, OnInputActivateDelegate) == 0x0006A0, "Member 'UUITextInputComponent::OnInputActivateDelegate' has a wrong offset!");
...
{
public:
	class ASceneCapture2D*                        SceneCaptureActor;                                 // 0x0810(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bSyncSizeToRT;                                     // 0x0818(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UViewportUITexture) == 0x000820, "Wrong size on UViewportUITexture");
static_assert(offsetof(UViewportUITexture, SceneCaptureActor) == 0x000810, "Member 'UViewportUITexture::SceneCaptureActor' has a wrong offset!");
static_assert(offsetof(UViewportUITexture, bSyncSizeToRT) == 0x000818, "Member 'UViewportUITexture::bSyncSizeToRT' has a wrong offset!");
